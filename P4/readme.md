...
Se utilizará la librería auxiliar GLUT para inicializar el contexto de OpenGL, crear el Frame Buffer, crear la ventana de renderizado y definir las funciones encargadas de tratar los eventos enviados por el sistema operativo. Además, se utilizará la librería GLEW para inicializar las extensiones. Gaussian blur, motion blur, dof...
