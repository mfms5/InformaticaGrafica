...
//Las propiedades del cubo se almacenan en vértices. Hay listas de vértices para las posiciones, normales, tangentes...
//*******************
...
//Triángulos compuestos por los vértices para saber cómo recorrerlos
//3 primeros: primer triángulo, 3 segundos: segundo triángulo...
const unsigned int cubeTriangleIndex[] = {
	//Cara z = 1
	0,1,2,			1,3,2, //Ordenación correcta para que se vea esta cara
	//Cara z = -1
	4,6,5,			5,6,7,
	//Cara x = 1
	8,10,9,			9,10,11,
...
//Hay más de 8 vértices porque se definen las caras de forma separada, poniendo los vértices una vez por cara
//Esto se hace porque cada vértice tiene una normal distinta según la cara en la que esté.
